    ...
    with progress as progress_bar:
        ...
        while not progress_bar.finished:
            ...
            with torch.no_grad():
                ...
                # CONSOLE.print(f"ray_bundle.shape: {ray_bundle.shape}", justify="center")
                outputs = pipeline.model(ray_bundle)
                semantic_outputs = pipeline.model.get_outputs(ray_bundle)
            ...
            semantic_rgb = pipeline.model.get_rgba_image(semantic_outputs, "semantics_colormap")
            ...
            rgb = rgba[mask][..., :3]
            semantic_rgb = semantic_rgb[mask][..., :3]
            ...
            if use_bounding_box:
                ...
                point = point[mask]
                rgb = rgb[mask]
                semantic_rgb = semantic_rgb[mask]
                view_direction = view_direction[mask]
                if normal is not None:
                    normal = normal[mask]
