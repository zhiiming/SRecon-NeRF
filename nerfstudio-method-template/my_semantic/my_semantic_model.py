...
@dataclass
class MySemanticNerfWModelConfig(NerfactoModelConfig):
    """Nerfacto Model Config"""

    _target: Type = field(default_factory=lambda: MySemanticNerfWModel)
...
class MySemanticNerfWModel(Model):
    """Nerfacto model
    ...
    config: MySemanticNerfWModelConfig

    def __init__(self, config: MySemanticNerfWModelConfig, metadata: Dict, **kwargs) -> None:
    ...
    def populate_modules(self):
        ...
        print("number of categories: %d" % len(self.semantics.classes))
        # Fields
        ...
        self.cross_entropy_loss = torch.nn.CrossEntropyLoss(reduction="mean", ignore_index=0)
